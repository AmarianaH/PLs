...
namespace PriceCompareUI.Forms
{
  ...
  */
    public partial class MostExpensive : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listBox1.Items.Count < 1)
                foreach (var item in _controller.GetTheMostExp3ItemsInStore(SelectedStore))
        ...
        private void MostExpensive_Load(object sender, EventArgs e)
        {
